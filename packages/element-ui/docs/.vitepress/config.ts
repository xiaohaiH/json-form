    ...
    return defineConfig({
        ...
        themeConfig: {
            ...
            nav: [
                ...
                { text: '更新日志', link: 'https://github.com/xiaohaiH/json-form/blob/master/packages/element-ui/CHANGELOG.md' },
            ],
            sidebar: {
                '/options': [
                    {
            ...
            socialLinks: [
                { icon: 'github', link: 'https://github.com/xiaohaiH/json-form/tree/master/packages/element-ui' },
            ],
        },
        // outDir: './dist',
        vite: {
